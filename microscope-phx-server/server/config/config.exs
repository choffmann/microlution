...
config :server, ServerWeb.Endpoint,
  ...
  live_view: [signing_salt: "Kutqhatn"]
...
config :esbuild,
  ...
  server: [
    args:
      ~w(js/app.js --bundle --target=es2017 --outdir=../priv/static/assets --external:/fonts/* --external:/images/* --loader:.woff=file --loader:.woff2=file --loader:.ttf=file),
